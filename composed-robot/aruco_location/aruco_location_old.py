...
#             #should be 
#             pitch,yaw,roll = rotationMatrixToEulerAngles(rotation_matrix_c_in_m)
...
#             tvec_str_in_marker = f"x={translation_vec_camera_in_marker[0]} y={translation_vec_camera_in_marker[1]} direction={math.degrees(roll)}"
...
#             tvec_str_in_world = f"x={translation_vec_camera_in_world[0]} y={translation_vec_camera_in_world[1]} direction={math.degrees(roll)}"
#             # if counter ==5:
#             #     print(tvec_str_in_world)
#             #     print('yaw',math.degrees(yaw),'pitch',math.degrees(pitch))
#             #     counter=0
#             # counter+=1

#             results.append([translation_vec_camera_in_world[0],translation_vec_camera_in_world[1],yaw,translation_vec_camera_in_world[2],pitch,roll])
